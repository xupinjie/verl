...
# ===================================== Data/Model =====================================
# geo3k + TQ SimpleStorage (no Mooncake). Companion of acc_text_30b_vl_geo3k_tq_gdr.sh —
# used to compare Mooncake vs SimpleStorage on the same VL workload.
...
experiment_name=${EXPERIMENT_NAME:-grpo-tq-simple-geo3k}
