...
if [[ $TASK_NAME == "gsm8k" ]]; then
    ...
    actor_model_path=/data/verl/Qwen3-30B-A3B
...
# wandb
# project_name=pinjiex_${TASK_NAME}_eos_0316
project_name=pinjiex_${TASK_NAME}_eos_megatron_2node_0319
experiment_name=qwen3-30B-$adv_estimator-$backend-$rollout_name-legacy
